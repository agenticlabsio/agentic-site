  ...
  return (
    <main className="pt-16">
        ...
        <section className="px-4 pt-20 pb-12 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-6xl">
            ...
            <h1 className="font-display mb-4 text-4xl font-bold tracking-tight text-stone-900 sm:text-5xl lg:text-6xl">
              Proof, <span className="text-brand-600">not promises.</span>
            </h1>
          ...
          <section className="px-4 pb-12 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-6xl">
              <Link
                ...
                className="hover:border-brand-500/50 block overflow-hidden rounded-2xl border border-stone-200 bg-stone-50 shadow-lg transition-all duration-300 hover:shadow-[0_16px_48px_-12px_rgba(91,141,255,0.25)]"
              >
                <div className="grid grid-cols-1 lg:grid-cols-2">
                  <div className="p-8 md:p-10">
                    ...
                    <p className="mb-6 text-stone-500">{featured.card.subtitle}</p>
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              {others.map((cs) => (
                ...
                >
                  ...
                  <h3 className="mb-1 text-xl font-semibold text-stone-900">{cs.card.title}</h3>
                  <p className="mb-4 text-sm text-stone-500">{cs.card.subtitle}</p>
        ...
        <section className="bg-stone-50 px-4 py-16 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-6xl">
            <h3 className="mb-10 text-center text-sm font-medium tracking-wider text-stone-500 uppercase">
              Representative Outcomes From Our Builds
            </h3>
            <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
              {aggregateStats.map((stat, i) => (
                <div key={i} className="text-center">
                  <div className="mb-1 text-3xl font-bold text-stone-900 lg:text-4xl">
                    {stat.value}
                  </div>
