      ...
      <main className="pt-16">
        ...
        <section className="pt-20 pb-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <p className="text-brand-400 font-medium text-sm uppercase tracking-wide mb-4">Solutions</p>
              ...
              <div className="bg-white/[0.02] rounded-2xl border border-white/10 overflow-hidden shadow-lg">
                <div className="grid grid-cols-1 lg:grid-cols-2">
                  <div className="p-8 md:p-10">
                    <div className="inline-flex items-center gap-2 px-3 py-1 bg-brand-500/10 text-brand-300 text-sm font-medium rounded-full mb-4">
                      {featured.category}
                    </div>
                    <h2 className="text-2xl sm:text-3xl font-bold text-stone-50 mb-4 font-display">
                      {featured.name}
                    </h2>
                ...
                >
                  ...
                  <div className="flex items-end justify-between">
                    <div>
                      ...
                      <div className="text-sm text-stone-400">{solution.metricLabel}</div>
                    </div>
