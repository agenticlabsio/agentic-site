export default function ContactFormSection() {
  return (
    <section id="contact" className="bg-brand-600 py-24 lg:py-32 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto text-center">
        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/30 rounded-full text-white text-sm font-medium mb-8">
        ...
        <h2 className="text-3xl sm:text-4xl lg:text-5xl text-white tracking-[-0.02em] mb-6">
          Start With a Discovery Session
        </h2>
        <p className="text-xl text-white mb-10 max-w-2xl mx-auto leading-relaxed">
          A complimentary session to assess your AI readiness, identify your highest-impact opportunity, and outline a clear path to production.
        </p>
