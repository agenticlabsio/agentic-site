...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative z-10 bg-white/90 backdrop-blur-md border-t border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <FadeInText delay={0.1} direction="up">
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-gray-900">Agentic Labs</h2>
          ...
          <FadeInText delay={0.3} direction="up">
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <a
                  href="#"
                  className="block text-gray-600 hover:text-gray-900 transition-colors duration-200 text-sm group"
                >
                ...
                >
                  <button className="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-full text-sm font-semibold hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-300 hover:scale-105">
                    Book a Demo
                  </button>
                </a>
              </div>
