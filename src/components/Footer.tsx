...
const socialLinks = [
  {
    name: 'LinkedIn',
    url: 'https://linkedin.com/company/agenticlabs',
    icon: (
  ...
  {
    name: 'GitHub',
    url: 'https://github.com/agenticlabs',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3 mb-6">
              {[
                { label: 'Blog (LinkedIn)', href: 'https://linkedin.com/company/agenticlabs', external: true },
                { label: 'Podcast', href: '#' },
