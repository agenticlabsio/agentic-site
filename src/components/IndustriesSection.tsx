        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-6xl mx-auto">
          ...
          <FadeInText delay={0.3} duration={0.8} direction="up">
            <div className="group flex flex-col items-center text-center space-y-3 p-4 rounded-xl hover:bg-white/50 transition-all duration-300">
              <div className="w-16 h-16 bg-gradient-to-br from-red-400 to-red-500 rounded-full flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300">
          ...
          <FadeInText delay={0.4} duration={0.8} direction="up">
            <div className="group flex flex-col items-center text-center space-y-3 p-4 rounded-xl hover:bg-white/50 transition-all duration-300">
              ...
              <h3 className="text-lg font-bold text-gray-900">Software & Platforms</h3>
              <p className="text-gray-600 text-sm">
          ...
          <FadeInText delay={0.5} duration={0.8} direction="up">
            <div className="group flex flex-col items-center text-center space-y-3 p-4 rounded-xl hover:bg-white/50 transition-all duration-300">
              <div className="w-16 h-16 bg-gradient-to-br from-teal-400 to-teal-500 rounded-full flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300">
                <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
          ...
          <FadeInText delay={0.6} duration={0.8} direction="up">
            <div className="group flex flex-col items-center text-center space-y-3 p-4 rounded-xl hover:bg-white/50 transition-all duration-300">
              <div className="w-16 h-16 bg-gradient-to-br from-amber-400 to-amber-500 rounded-full flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300">
                <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-lg font-bold text-gray-900">Manufacturing & Industry 4.0</h3>
              <p className="text-gray-600 text-sm">
          ...
          <FadeInText delay={0.7} duration={0.8} direction="up">
            <div className="group flex flex-col items-center text-center space-y-3 p-4 rounded-xl hover:bg-white/50 transition-all duration-300">
              <div className="w-16 h-16 bg-gradient-to-br from-purple-400 to-purple-500 rounded-full flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300">
                <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M11.8 10.9c-2.27-.59-3-1.2-3-2.15 0-1.09 1.01-1.85 2.7-1.85 1.78 0 2.44.85 2.5 2.1h2.21c-.07-1.72-1.12-3.3-3.21-3.81V3h-3v2.16c-1.94.42-3.5 1.68-3.5 3.61 0 2.31 1.91 3.46 4.7 4.13 2.5.6 3 1.48 3 2.41 0 .69-.49 1.79-2.7 1.79-2.06 0-2.87-.92-2.98-2.1h-2.2c.12 2.19 1.76 3.42 3.68 3.83V21h3v-2.15c1.95-.37 3.5-1.5 3.5-3.55 0-2.84-2.43-3.81-4.7-4.4z" />
                </svg>
              </div>
              <h3 className="text-lg font-bold text-gray-900">Banking & Insurance</h3>
              <p className="text-gray-600 text-sm">
          ...
          <FadeInText delay={0.8} duration={0.8} direction="up">
            <div className="group flex flex-col items-center text-center space-y-3 p-4 rounded-xl hover:bg-white/50 transition-all duration-300">
              <div className="w-16 h-16 bg-gradient-to-br from-cyan-400 to-cyan-500 rounded-full flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300">
                <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M20 8h-3V4H3c-1.1 0-2 .9-2 2v11h2c0 1.66 1.34 3 3 3s3-1.34 3-3h6c0 1.66 1.34 3 3 3s3-1.34 3-3h2v-5l-3-4zM6 18.5c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zm13.5-9l1.96 2.5H17V9.5h2.5zm-1.5 9c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5z" />
                </svg>
              </div>
              <h3 className="text-lg font-bold text-gray-900">Supply Chain & Logistics</h3>
              <p className="text-gray-600 text-sm">
