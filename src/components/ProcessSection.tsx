  ...
  const phases = [
    {
      ...
      title: 'Discovery',
      duration: 'Week 1',
      description: 'Rapid diagnostic of your systems. Identify highest-ROI opportunity. Define measurable success criteria. Scope approval before code.',
      icon: (
    ...
    },
    {
      ...
      title: 'Design',
      duration: 'Weeks 2-3',
      description: 'Solution architecture, integration points, security model. Technical specifications reviewed and approved.',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      title: 'Build',
      duration: 'Weeks 4-6',
      description: 'Bi-weekly working demos. Continuous feedback integration. Your team embedded with ours throughout.',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      title: 'Deploy',
      duration: 'Weeks 7-8',
      description: 'Production deployment with comprehensive testing. Knowledge transfer complete. 90-day hypercare included.',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl text-stone-900 tracking-[-0.02em] mb-4">
            The Production-First Methodology
          </h2>
          <p className="text-xl text-stone-600 max-w-2xl mx-auto">
            A battle-tested framework refined across 50+ enterprise deployments. Every phase has defined deliverables. Every week moves toward production.
          </p>
        </div>
