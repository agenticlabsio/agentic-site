          ...
          <div className="grid grid-cols-2">
            <div className="border-r border-white/10 p-6">
              ...
              <ul className="space-y-3">
                {before.map((item, i) => (
                  <li key={i} className="font-body text-sm text-stone-400">
                    {item}
                  </li>
                ))}
              </ul>
            ...
            <div className="bg-brand-500/10 p-6">
              <h3 className="text-brand-300 font-display mb-4 text-sm font-semibold tracking-wider uppercase">
                After
              </h3>
              <ul className="space-y-3">
                {after.map((item, i) => (
                  <li key={i} className="font-body text-sm font-medium text-stone-50">
                    {item}
                  </li>
                ))}
              </ul>
