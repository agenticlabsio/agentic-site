export function NeuralNetworkIcon({
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className}>
      ...
      />
      <path
        d="M24 12v6M12 24h6M30 24h6M24 30v6"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
      <path
        d="M18 18l-6-6M30 18l6-6M18 30l-6 6M30 30l6 6"
        stroke="currentColor"
        strokeWidth="1"
        strokeLinecap="round"
        opacity="0.5"
...
export function AgentBrainIcon({
  size = 48,
  className = '',
}: {
  size?: number
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className}>
      <path
        d="M24 4c-8.837 0-16 7.163-16 16 0 6.627 4.03 12.32 9.778 14.738L24 44l6.222-9.262C35.97 32.32 40 26.627 40 20c0-8.837-7.163-16-16-16z"
        stroke="currentColor"
        strokeWidth="1.5"
      />
...
export function WorkflowIcon({ size = 48, className = '' }: { size?: number; className?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className}>
      ...
      <path
        d="M12 14v6a4 4 0 004 4h16a4 4 0 004-4v-6"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
...
export function RocketIcon({ size = 48, className = '' }: { size?: number; className?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className}>
      <path
        d="M24 4c-8 8-8 24-4 32l4-8 4 8c4-8 4-24-4-32z"
        stroke="currentColor"
        strokeWidth="1.5"
        fill="currentColor"
        fillOpacity="0.1"
      ...
      <path
        d="M16 32c-4 2-8 6-8 10h8M32 32c4 2 8 6 8 10h-8"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
...
export function SupportAgentIcon({
  size = 48,
  className = '',
}: {
  size?: number
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className}>
      ...
      <path
        d="M12 20c0-6.627 5.373-12 12-12s12 5.373 12 12"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
      <path
        d="M8 20v4a4 4 0 004 4M40 20v4a4 4 0 01-4 4"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
...
export function SpeedIcon({ size = 48, className = '' }: { size?: number; className?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className}>
      ...
      />
      <path
        d="M12 32l-2 2M36 32l2 2M8 24H6M42 24h-2M14 16l-2-2M34 16l2-2M24 12v-2"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
...
export function InfinityLoopIcon({
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className}>
      <path
        d="M14 24c0-5.523-4.477-10-10-10s-10 4.477-10 10 4.477 10 10 10 10-4.477 10-10zM34 24c0 5.523 4.477 10 10 10s10-4.477 10-10-4.477-10-10-10-10 4.477-10 10z"
        stroke="currentColor"
        strokeWidth="1.5"
